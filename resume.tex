...
\begin{tabular}{r|p{8.5cm}}
 \emph{Current}&Systems Engineer at \textsc{IBM}\\\textsc{Aug 2015}&\emph{Cloud Video Unit}\\&\footnotesize{Provided application-level and infrastructure-level support for an agile-developed SaaS application in the cloud. Responsibilities include bug triage and mitigation in a production environment; deploying, upgrading, and maintaining all development, QA, pre-production, and production environments.}\\\multicolumn{2}{c}{}\\
...
\section{Skills}
\begin{tabular}{rl}
 \textbf{Operations}&\\\textsc{Basic Knowledge:}&\footnotesize{Docker, Puppet, PostgreSQL, Jenkins}\\\textsc{Proficiency:}&\footnotesize{Ansible, Terraform, BASH}\\\multicolumn{2}{c}{}\\
