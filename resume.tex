...
\begin{tabular}{r|p{8.5cm}}
 ...
 \emph{Sep 2018 -}&DevOps Engineer at \textsc{Home Depot}\\\textsc{Mar 2019}&\emph{Contractor}\\&\footnotesize{Provide a CI/CD toolchain in the cloud for an agile development team. Provision, configure, and maintain Kubernetes clusters on which the team's services are deployed.}\\\multicolumn{2}{c}{}\\
