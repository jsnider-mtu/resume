...
\begin{tabular}{r|p{8.5cm}}
 \emph{Current}&DevOps Engineer at \textsc{Home Depot}\\\textsc{Sep 2018}&\emph{Contractor}\\&\footnotesize{Provide a CI/CD toolchain in the cloud for an agile development team. Provision, configure, and maintain Kubernetes clusters on which the team's services are deployed.}\\\multicolumn{2}{c}{}\\
...
\section{Skills}
\begin{tabular}{rl}
 \textbf{Development}&\\\textsc{Basic Knowledge:}&\footnotesize{Python, Git}\\\multicolumn{2}{c}{}\\
 \textbf{Operations}&\\\textsc{Basic Knowledge:}&\footnotesize{Chef, Docker, Puppet, PostgreSQL}\\\textsc{Proficiency:}&\footnotesize{Ansible, BASH, Concourse, Jenkins, Terraform}\\\multicolumn{2}{c}{}\\
