...
\section{Skills}
\begin{tabular}{rl}
 \textbf{Operations}&\\\textsc{Basic Knowledge:}&\footnotesize{Docker, Puppet, PostgreSQL}\\\textsc{Proficiency:}&\footnotesize{Ansible, Jenkins, Terraform, BASH}\\\multicolumn{2}{c}{}\\
